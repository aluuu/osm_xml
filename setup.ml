...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4cf349762a3151d809ed3d0ce2ea99d1) *)
(*
...
let setup_t =
  {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/osm_xml";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\197\140\223\176\155]\223(\185SA\17478=\222";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
